/**
 * Чистые решения навигации врага — Phaser-free. Применение (пропуск вейпоинта, пересчёт
 * пути, работа с таймерами) остаётся за `ai/PathFollower.ts`, движение — за `Enemy`.
 */
